...
const Info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 '>
            <InfoCard cardTitle="Opening Hours" bgClass="bg-accent" body="Our opening hour monday to friday 9am to 5pm you can visit our factory for purchase.All our office are maintained same time zone." img={clock}></InfoCard>
